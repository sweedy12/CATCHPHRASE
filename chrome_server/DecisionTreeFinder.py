...
def model_cross_validation(model_type,train_name, val_name,test_name,param_lists):
    ...
    print(count)
    test_acc = check_model_on_data(best_model, test_data)
...
if __name__ =="__main__":
    ...
    #     # pd.balance_by_sent()
        write_train_validation_test(pd, 0.6,0.2,train_feature_fname,val_feature_fname,test_feature_fname, balanced=False)
    ...
    #     model, acc,val_acc,best_params = model_cross_validation(RANDOM_FOREST,train_feature_fname,val_feature_fname,test_feature_fname,random_forest_params)
    #     write_model(model,acc,rf_model_path,acc_path,best_params)
    #     write_model_info_to_file(model,RANDOM_FOREST,best_params,rf_param_names,acc,val_acc,rf_model_info_name)
    #     print("done")
    #
    #
        # svm:
