...
def train_lstm_crf_with_w2v(train_data, val_data, test_data, n_epochs,lr, weight_decay, n_layers, hidden_dim,k):
    batch_size = 64
    dropout = 0.5
...
if __name__ == '__main__':
    ...
    # model_tester = test.ModelChecker(model, "CRF", "model_test_file")
    # model_tester.write_model_examples_to_file("CRF_model_output_k=1",model)
